...
/* Приклад головної функції програми
 * Зараз вона виводить повідомлення "Hello, World!"
 */
fun main() {
    println("Hello, World!")
    var a:Int = 2
...
/* Приклад написання функції, яка складається з одного виразу
 * В цьому випадку, вказувати тип функції необов'язково, Kotlin сам "виведе" його
 */
